-- Create AI tables with RLS and triggers
...
CREATE POLICY "Allow authenticated users to manage ai_threads"
...
CREATE POLICY "Allow authenticated users to manage ai_messages"
...
DROP POLICY IF EXISTS "Allow authenticated users to manage customer_enrichment" ON public.customer_enrichment;
CREATE POLICY "Allow authenticated users to manage customer_enrichment"
ON public.customer_enrichment
FOR ALL
USING (auth.role() = 'authenticated')
WITH CHECK (auth.role() = 'authenticated');

CREATE TRIGGER update_customer_enrichment_updated_at
...
DROP POLICY IF EXISTS "Allow authenticated users to manage customer_notes" ON public.customer_notes;
CREATE POLICY "Allow authenticated users to manage customer_notes"
